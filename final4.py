...
def main():
    ...
    # Continuous prompting for analysis
    while True:
        # Analysis type selection
        analysis_type = input("Select analysis type (A, B, C, D, E) or type 'exit' to finish: ").strip().upper()
        if analysis_type == 'EXIT':
            break
        elif analysis_type not in ['A', 'B', 'C', 'D', 'E']:
            print("Invalid analysis type selected. Please choose from A, B, C, D, E or type 'exit' to finish.")
            continue
